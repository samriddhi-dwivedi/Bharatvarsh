...
<body>
    ...
    <section class="mainsection">
        ...
        <div class="container comment-tab inp">
            <div class="row">
                <div class="col-lg-1 user-avatar ua">
                ...
                <div class="col-lg-9 comment-details">
                    <h4 class="username un"><?php echo $_SESSION['user']; ?></h4>
                    ...
                    <form action="./comment.php?id=<?php echo $p_id; ?>" method="post">
                        ...
                        <div style="text-align: center;margin-left: 30px;"><input type="submit" name="submit" role="button" value="POST" /></div>
        ...
        <div class="mt-5" style="background: rgba(233, 173, 120, 0.46);overflow-y:hidden;">
            <div class="container pt-5 pb-5" style="overflow-y: hidden;">
                ...
                <div class="row mx-0 d-flex align-items-between justify-content-between cont" style="padding-bottom: 60px;overflow-y:hidden;">
                    ...
                    <?php
                    $i = 0;
                    $sql = "select * from posts WHERE approval=1 AND class='{$class}' AND post_id<>'{$p_id}'  ORDER BY post_id DESC";
                    $result = mysqli_query($conn, $sql) or die("Query Failed");
                    $num = mysqli_num_rows($result);
